...
print("-------")
result = subprocess.run("export PATH=~/.local/share/junest/bin:$PATH",shell=True,capture_output=True)
print(result)
st.write("stdout:", result.stdout)
st.write("stderr:", result.stderr)
print("-------")
result = subprocess.run("junest setup",shell=True,capture_output=True)
print(result)
st.write("stdout:", result.stdout)
st.write("stderr:", result.stderr)
