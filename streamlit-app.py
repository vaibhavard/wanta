...
result = subprocess.run("git clone https://github.com/fsquillace/junest.git ~/.local/share/junest",shell=True,capture_output=True)
print(result)
st.write("stdout:", result.stdout)
st.write("stderr:", result.stderr)
print("-------")
result = subprocess.run("cd ~/.local/share/junest/bin && ./junest setup",shell=True,capture_output=True)
print(result)
st.write("stdout:", result.stdout)
st.write("stderr:", result.stderr)
print("-------")
subprocess.run("ls ~/.local/share/junest/bin",shell=True)
result = subprocess.run("cd ~/.local/share/junest/bin && ./junest ns -f pacman -Syu",shell=True,capture_output=True)
print(result)
st.write("stdout:", result.stdout)
st.write("stderr:", result.stderr)
